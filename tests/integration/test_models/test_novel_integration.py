...
class TestNovelModelIntegration:
    ...
    def test_timestamp_automation(self, db_session):
        ...
        # Add a small delay to ensure timestamp difference (SQLite has second precision)
        time.sleep(1.1)  # Sleep for 1.1 seconds to ensure second boundary is crossed
        ...
        # Verify updated_at changed (should be greater due to the sleep)
