...
class TestSchemaModelIntegration:
    ...
    def test_orm_to_schema_conversion_project(self, db_session):
        ...
        # Convert to Pydantic schema - use model_validate for Pydantic V2
        project_schema = ProjectSchema.model_validate(project_orm)
    ...
    def test_orm_to_schema_conversion_chapter(self, db_session):
        ...
        chapter_schema = ChapterSchema.model_validate(chapter_orm)
    ...
    def test_orm_to_schema_conversion_scene(self, db_session):
        ...
        # Convert to Pydantic schema
        scene_schema = SceneSchema.model_validate(scene_orm)
    ...
    def test_schema_to_orm_compatibility(self, db_session):
        ...
        project_orm = Project(**project_data.model_dump())
        ...
        # Use model_dump with exclude for Pydantic V2
        chapter_orm = Chapter(**chapter_data.model_dump(exclude={'project_id'}))
